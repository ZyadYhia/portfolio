...
export const skills: SkillGroup[] = [
    {
        ...
        tags: [
            ...
            { label: 'Inertia.js', highlight: 'secondary' },
            { label: 'Redux / Zustand', highlight: 'secondary' },
            { label: 'React Query', highlight: 'secondary' },
            { label: 'Angular', highlight: 'secondary' },
            { label: 'Vue.js / Quasar' },
            { label: 'Tailwind' },
            { label: 'ShadCN' },
            { label: 'Bootstrap' },
    ...
    },
    {
        ...
        tags: [
            ...
            { label: 'ASP.NET Core', highlight: 'primary' },
            { label: 'C# / EF Core', highlight: 'primary' },
            { label: 'WordPress' },
            { label: 'Go / Gorm' },
            { label: 'REST APIs' },
            { label: 'MCP Protocol' },
    ...
    },
    {
        title: 'Infra & Tooling',
        tags: [
            { label: 'Git / GitHub', highlight: 'primary' },
            { label: 'Laravel Cloud', highlight: 'secondary' },
            { label: 'Docker', highlight: 'secondary' },
            { label: 'CI/CD', highlight: 'secondary' },
            { label: 'Self-hosted / On-prem' },
            { label: 'Jira / Mantis' },
            { label: 'yarn / npm / Composer' },
        ],
    },
    {
        title: 'IoT & Systems',
        tags: [
            { label: 'MCP Protocol', highlight: 'primary' },
